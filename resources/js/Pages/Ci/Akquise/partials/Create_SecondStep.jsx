                    ...
                    {creatables.map((creatable, index) =>
                        index < shownItems ? (
                            ...
                            >
                                ...
                                <p>
                                    {creatable.composed.zip_code +
                                        " " +
                                        creatable.composed.city}
                                </p>
                ...
                <>
                    ...
                    {shownItems >= 40 ? (
                        <p className="text-center mt-4 p-2">
                            Noch nicht das richtige Ergebnis dabei? Dann muss
                            vielleicht die Suche präzisiert werden.
                            <br />
